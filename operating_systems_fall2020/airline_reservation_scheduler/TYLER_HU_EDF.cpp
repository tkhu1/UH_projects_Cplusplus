...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   //the following does EDF scheduling////////////////////////////////////////////////////////////////////////////////////////////////
   cout << "\n=========================" << endl;
   cout << "     EDF Scheduling"      << endl;
   cout << "=========================" << endl;
      ...
      //this is the parent process that schedules the transactions
         ...
         for (int j = 0; j < transactionsEDF.size(); j++) {
            ...
            */
            ...
            int transAgentNum = transactionsEDF[j].agentNum;
            //gets transaction ID to send to agent
            int transAgentTransID = transactionsEDF[j].transactionID;
