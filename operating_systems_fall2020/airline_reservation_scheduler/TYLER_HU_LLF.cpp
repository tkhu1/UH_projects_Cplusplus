...
int main(int argc, char *argv[])
{
   ...
   */
   ...
   //the following does LLF scheduling////////////////////////////////////////////////////////////////////////////////////////////////
   cout << "\n=========================" << endl;
   cout << "     LLF Scheduling"      << endl;
   cout << "=========================" << endl;
      ...
      //this is the parent process that schedules the transactions
         ...
         for (int j = 0; j < transactionsLLF.size(); j++) {
            ...
            */
            ...
            int transAgentNum = transactionsLLF[j].agentNum;
            //gets transaction ID to send to agent
            int transAgentTransID = transactionsLLF[j].transactionID;
