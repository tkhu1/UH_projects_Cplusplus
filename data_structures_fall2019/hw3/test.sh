...
diff -iEBwu anss31.txt output31.txt > 1.diff
...
diff -iEBwu anss32.txt output32.txt > 2.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss33.txt output33.txt > 3.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss34.txt output34.txt > 4.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss35.txt output35.txt > 5.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss36.txt output36.txt > 6.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss37.txt output37.txt > 7.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss38.txt output38.txt > 8.diff
if [ $? -ne 0 ]; then
...
diff -iEBwu anss39.txt output39.txt > 9.diff
if [ $? -ne 0 ]; then
